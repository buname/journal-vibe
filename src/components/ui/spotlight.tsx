...
export function Spotlight({
  ...
  return (
    <motion.div
      ref={containerRef}
      className={cn(
        "pointer-events-none absolute z-0 rounded-full bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops),transparent_72%)] blur-2xl transition-opacity duration-300",
